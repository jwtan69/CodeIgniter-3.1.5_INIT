    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?=base_url($init['langu'].'/vo/index')?>">SB Admin v2.0</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?=base_url($init['langu'].'/vo/index')?>"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?=base_url($init['langu'].'/vo/users/list')?>">Manage Setting</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
